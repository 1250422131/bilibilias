        ...
        when (it) {
            ...
            RequestFrequentUIState.Success -> {
                Column(
                    ...
                    Text(stringResource(R.string.request_success), modifier = Modifier.padding(top = 16.dp))
                    Button(onClick = onToBack) {
                        Text(stringResource(R.string.back_to_continue))
                    }
                }
            }
        }
...
private fun DefaultScreen(
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = stringResource(R.string.server_error_icon),
            modifier = Modifier.size(64.dp),
            tint = MaterialTheme.colorScheme.primary
        )

        Text(
            text = stringResource(R.string.emergency_event),
            style = MaterialTheme.typography.headlineMedium,
            modifier = Modifier.padding(top = 20.dp),
        )
        Text(
            text = stringResource(R.string.bilibili_server_busy),
        ...
        Button(
            ...
            Text(text = stringResource(R.string.home_text_4059))
        }
        ...
        OutlinedButton(
            ...
            Text(text = stringResource(R.string.home_text_7711))
        }
