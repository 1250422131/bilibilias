        ...
        when (it) {
            ...
            RequestFrequentUIState.Loading -> {
                Column(
                    ...
                    Text(stringResource(R.string.app_请求测), modifier = Modifier.padding(top = 16.dp))
                }
            }
            ...
            RequestFrequentUIState.Success -> {
                Column(
                    ...
                    Text(stringResource(R.string.app_请求成_可以正), modifier = Modifier.padding(top = 16.dp))
                    Button(onClick = onToBack) {
                        Text(stringResource(R.string.app_返回继))
                    }
                }
            }
        }
...
private fun DefaultScreen(
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = stringResource(R.string.app_服务器),
            modifier = Modifier.size(64.dp),
            tint = MaterialTheme.colorScheme.primary
        )

        Text(
            text = stringResource(R.string.app_突发事),
            style = MaterialTheme.typography.headlineMedium,
            modifier = Modifier.padding(top = 20.dp),
        )
        Text(
            text = stringResource(R.string.app_站当前_暂时无),
            style = MaterialTheme.typography.bodyLarge,
            modifier = Modifier.padding(top = 20.dp),
            textAlign = TextAlign.Center
        )
        Text(
            text = stringResource(R.string.app_但请注_如果仅),
        ...
        Button(
            ...
            Text(text = stringResource(R.string.login_重试))
        }
        ...
        OutlinedButton(
            ...
            Text(text = stringResource(R.string.app_退出应))
        }
