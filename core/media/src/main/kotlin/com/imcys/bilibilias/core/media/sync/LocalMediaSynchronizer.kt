...
import com.imcys.bilibilias.core.media.model.MediaVideo
import com.imcys.bilibilias.core.network.di.ApplicationScope
import com.imcys.bilibilias.core.utils.VIDEO_COLLECTION_URI
import com.imcys.bilibilias.core.utils.getStorageVolumes
import com.imcys.bilibilias.core.utils.scanPaths
import com.imcys.bilibilias.core.utils.scanStorage
...
class LocalMediaSynchronizer @Inject constructor(
    ...
    @Dispatcher(AsDispatchers.IO) private val dispatcher: CoroutineDispatcher,
) : MediaSynchronizer {
    ...
    private suspend fun updateDirectories(media: List<MediaVideo>): Nothing =
...
//     val unwantedThumbnailFiles =
//         unwantedMedia.mapNotNull { medium -> medium.thumbnailPath?.let { File(it) } }
...
//     launch {
//         val currentMediaExternalSubs =
//             mediumEntities.flatMap { UriListConverter.fromStringToList(it.externalSubs) }.toSet()
//
