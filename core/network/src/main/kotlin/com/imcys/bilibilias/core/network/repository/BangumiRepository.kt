...
class BangumiRepository @Inject constructor(
    ...
    suspend fun 获取剧集详情(epid: Long): BangumiDetail = client.get("pgc/view/web/season") {
        parameterEPid(epid)
    }.body()

    suspend fun videoStreamingURL(aid: Long, cid: Long, epid: Long): BangumiStreamUrl = client.get("/pgc/player/web/v2/playurl") {
