...
/**
 * @author:imcys @create: 2022-10-26 17:25
 *
 * @sample { "code":0, "message":"0", "ttl":1, "data":{
 ...
 * @see <a
 *     href="https://github.com/SocialSisterYi/bilibili-API-collect/blob/master/docs/login/login_action/QR.md">
 *     二维码登录</a>
 * @description: 登陆二维码数据
 */
@Serializable
