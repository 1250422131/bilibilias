...
@Database(entities = [DownloadTasEntity::class], version = 1, autoMigrations = [])
@TypeConverters(InstantConverter::class, UriConverters::class, builtInTypeConverters = BuiltInTypeConverters())
